            ...
            if (!eligible) ...[
              ...
              _actionBtn(
                ...
                onTap: () => Navigator.push(context,
                    MaterialPageRoute(
                        builder: (_) => ScreeningForm(
                          existingScreeningId: crf.screeningId,
                        ))),
              ),
            ],
          ]),
      ...
      builder: (_) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          _helperTile("minimal_monitoring", Icons.monitor_heart_outlined,
              "Daily Monitoring Sheet (DMS)", "Same-day CV/resp/metab/GI/neuro/hema scratchpad",
              const Color(0xFF7C3AED), crf),
          _helperTile("resp", Icons.favorite_outline_rounded,
              "Helper 2 — Resp / CV / Neuro", "Respiratory, cardiac & neurological",
              _success, crf),
          _helperTile("fio2", Icons.air_rounded,
              "Helper 3 — FiO₂ Logging", "Supplemental O₂ days from Helper 2",
              const Color(0xFF0284C7), crf),
          _helperTile("infect", Icons.biotech_outlined,
              "Helper 4 — Infect / GI / Hema", "Infection, feeds & haematology",
              _danger, crf),
          _helperTile("metab", Icons.science_outlined,
              "Helper 5 — Metab / Renal / Eye", "Metabolic, renal, lines & ROP",
              _warning, crf),
        ]),
      ),
    );
