      ...
      builder: (_) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          _helperTile("minimal_monitoring", Icons.monitor_heart_outlined,
              "Helper Form 1 — Minimal Monitoring", "Same-day CV/resp/metab/GI/neuro/hema scratchpad",
          ...
          _helperTile("fio2", Icons.air_rounded,
              "Helper Form 3 — FiO₂ Logging", "Supplemental O₂ days from Helper Form 2",
              const Color(0xFF0284C7), crf),
          _helperTile("infect", Icons.biotech_outlined,
              "Helper Form 4 — Infect / GI / Hema", "Infection, feeds & haematology",
              _danger, crf),
          _helperTile("metab", Icons.science_outlined,
              "Helper Form 5 — Metab / Renal / Eye", "Metabolic, renal, lines & ROP",
              _warning, crf),
        ]),
      ),
    );
